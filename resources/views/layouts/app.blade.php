...
<body>
    ...
    <li class="no-padding">
      <ul class="collapsible collapsible-accordion">
      	<li>
      		 <a href=""><i class="fa fa-home fa-3"></i> Home</a>
      	</li>
      	@auth
      	<li class="bold">
          ...
          <div class="collapsible-body">
            <ul>
              <li><a href="color.html">Profile <i class="fa fa-user black-text"></i></a></li>
              <li><a href="grid.html">Settings<i class="fa fa-gear black-text"></i></a></li>
              <li><a href="helpers.html">My girlfriend <i class="fa fa-heart black-text"></i></a></li>
              <li><a href="breadcrumbs.html">Logout <i class="fa fa-sign-out"></i></a></li>
            </ul>
          </div>
        </li>
        @endauth
